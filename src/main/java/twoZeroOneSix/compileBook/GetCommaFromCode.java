...
import twoZeroOneSix.GsonUtils;
...
public class GetCommaFromCode {
    ...
    public static void main(String[] args) {
        String code="package twoZeroOneSix.compileBook;\n" +
                "\n" +
                "/**\n" +
                " * Created by bruce.ge on 2016/10/27.\n" +
                " */\n" +
                ...
                "    }\n" +
                "}";
        //first get the most simple things done.

        String simple = "  hello   world ";
        GsonUtils.printToGson(getTokensFromCode(simple));
